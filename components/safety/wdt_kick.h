 ...
 *
 * KILN_PIN_WDT_KICK retriggers a monostable whose output gates the +5V gate-drive
 * rail behind BOTH channels, and it retriggers on EDGES — a pin wedged at either level expires
