...
static const cone_entry_t s_cone_table[CONE_COUNT] = {
    [CONE_022] = {"022", {586, 590, 605}},  [CONE_021] = {"021", {600, 605, 616}},
    ...
    [CONE_06] = {"06", {991, 999, 1023}},   [CONE_05_5] = {"05.5", {1011, 1020, 1043}},
    [CONE_05] = {"05", {1031, 1046, 1066}}, [CONE_04] = {"04", {1050, 1060, 1083}},
    [CONE_03] = {"03", {1086, 1101, 1115}}, [CONE_02] = {"02", {1101, 1120, 1138}},
    [CONE_01] = {"01", {1117, 1137, 1154}}, [CONE_1] = {"1", {1136, 1154, 1162}},
    [CONE_2] = {"2", {1142, 1162, 1173}},   [CONE_3] = {"3", {1152, 1168, 1181}},
    [CONE_4] = {"4", {1162, 1182, 1196}},   [CONE_5] = {"5", {1177, 1196, 1207}},
    [CONE_6] = {"6", {1201, 1222, 1240}},   [CONE_7] = {"7", {1215, 1239, 1255}},
    [CONE_8] = {"8", {1236, 1252, 1274}},   [CONE_9] = {"9", {1260, 1280, 1285}},
    [CONE_10] = {"10", {1285, 1305, 1315}}, [CONE_11] = {"11", {1294, 1315, 1326}},
    [CONE_12] = {"12", {1306, 1326, 1355}}, [CONE_13] = {"13", {1321, 1348, 1380}},
                             ...
                             firing_profile_t *out_profile)
{
    ...
    snprintf(out_profile->id, FIRING_ID_LEN, "cone-%s-%s", s_cone_table[cone].name, s_speed_names[speed]);
    ...
    snprintf(out_profile->description, FIRING_DESC_LEN, "Orton cone %s at %s speed (%.0f°C/hr). Target: %.0f°C.",
    ...
    {
        snprintf(out_profile->segments[seg].id, FIRING_ID_LEN, "%d", seg + 1);
        snprintf(out_profile->segments[seg].name, FIRING_NAME_LEN, "Ramp to cone %s", s_cone_table[cone].name);
    ...
    ESP_LOGI(TAG, "Generated cone %s %s profile: %.0f°C, %d segments, ~%d min", s_cone_table[cone].name,
             s_speed_names[speed], target_temp, seg, out_profile->estimated_duration);
