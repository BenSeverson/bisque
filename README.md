...
- [ESP-IDF v6.1](https://docs.espressif.com/projects/esp-idf/en/v6.1/esp32s3/get-started/)
- Node.js 18+
...
pins the exact ESP-IDF v6.1 image CI uses plus Node 24, the static-analysis
