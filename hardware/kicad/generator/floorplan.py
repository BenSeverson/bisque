...
REGIONS = {
    ...
    "ANA1E": (100.5, 31.5, 132.0, 44.5),
    "ANA2W": (86.5, 45.5, 93.5, 57.0),
    "ANA2E": (100.5, 45.5, 132.0, 57.0),
    # ADE7953: QFN-28 escapes radially, so x 88.5..101.5 / y 61..73.5 is its
    # fan-out annulus and holds nothing else.
    "ANA3T": (86.0, 57.2, 132.0, 63.4),
    "ANA3U": (86.0, 63.5, 132.0, 68.0),
    "ANA3W": (86.0, 68.5, 90.4, 77.0),
    "ANA3E": (102.0, 68.3, 132.0, 77.0),
    "ANA3S": (86.0, 77.5, 132.0, 95.0),
    "BOT1": (41.0, 94.0, 132.0, 100.3),
    "BOT2": (32.0, 108.0, 59.0, 119.0),
}

FIXED = {
    # mechanical
    "H1": (25.5, 25.0, 0), "H2": (140.5, 25.0, 0),
    "H3": (25.5, 115.0, 0), "H4": (140.5, 115.0, 0),
    # module
    "U1": (70.0, 34.0, 0),
...
SEED = {
    ...
    "R5": (43.5, 34.4, 0, "TOPB"), "U4": (48.0, 34.4, 0, "TOPB"),
    "R4": (51.0, 34.4, 0, "TOPB"), "D2": (56.4, 35.3, 0, "TOPB"),
    ...
    "R14": (104.0, 37.5, 180, "ANA1E"), "R15": (109.0, 37.5, 180, "ANA1E"),
    "C15": (114.0, 37.5, 0, "ANA1E"), "C16": (119.0, 37.5, 0, "ANA1E"),
    "C17": (124.0, 37.5, 0, "ANA1E"),
    "C18": (90.0, 47.5, 0, "ANA2W"), "C19": (90.0, 53.0, 0, "ANA2W"),
    # U5 is rot 90, so its analog row escapes SOUTH; same single-row idea.
    "R16": (104.0, 49.5, 180, "ANA2E"), "R17": (109.0, 49.5, 180, "ANA2E"),
    "C20": (114.0, 49.5, 0, "ANA2E"), "C21": (119.0, 49.5, 0, "ANA2E"),
    "C22": (124.0, 49.5, 0, "ANA2E"),
    # --- ANA3: ADE7953, crystal, straps, decoupling, CT front-end ---------
    "Y1": (113.0, 71.0, 0, "ANA3E"),
    ...
    "C25": (107.0, 65.5, 0, "ANA3U"), "C26": (119.0, 65.5, 0, "ANA3U"),
    "R30": (104.0, 60.0, 0, "ANA3T"), "C37": (109.0, 60.0, 0, "ANA3T"),
    "R37": (114.0, 60.0, 0, "ANA3T"), "R38": (119.0, 60.0, 0, "ANA3T"),
    "C29": (88.2, 70.0, 0, "ANA3W"), "C30": (88.2, 73.5, 0, "ANA3W"),
    "C27": (104.0, 75.8, 0, "ANA3E"), "C28": (109.0, 75.8, 0, "ANA3E"),
    "C35": (114.0, 75.8, 0, "ANA3E"), "C36": (119.0, 75.8, 0, "ANA3E"),
    "C33": (92.0, 79.5, 0, "ANA3S"), "C34": (97.5, 79.5, 0, "ANA3S"),
    "J13": (104.0, 80.5, 0, "ANA3S"),
    "R32": (89.0, 84.0, 180, "ANA3S"), "R31": (95.0, 84.0, 0, "ANA3S"),
    "R33": (101.0, 84.0, 0, "ANA3S"), "C31": (107.0, 84.0, 0, "ANA3S"),
    "R35": (89.0, 90.0, 180, "ANA3S"), "R34": (95.0, 90.0, 0, "ANA3S"),
    "R36": (101.0, 90.0, 0, "ANA3S"), "C32": (107.0, 90.0, 0, "ANA3S"),
    "D6": (113.0, 84.0, 0, "ANA3S"), "TP11": (113.0, 90.0, 0, "ANA3S"),
    ...
    "R44": (76.0, 96.5, 0, "BOT1"), "R45": (79.5, 96.5, 0, "BOT1"),
    "J14": (84.0, 96.8, 0, "BOT1"), "R3": (91.0, 96.8, 0, "BOT1"),
    "LED1": (98.0, 96.8, 0, "BOT1"), "D3": (105.0, 96.8, 0, "BOT1"),
    "C10": (110.5, 96.5, 0, "BOT1"),
