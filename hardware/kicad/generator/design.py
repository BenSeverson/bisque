...
COMPONENTS = {
    ...
    "J5": dict(lib="Connector_Generic", sym="Conn_01x08",
               ...
               fpf="PinHeader_1x08_P2.54mm_Vertical.kicad_mod",
               value="DISPLAY", at=(24.5, 95.0, 90),
